...
namespace QuizList
{
    class List
    {
        ...
        public static void Quiz12()
        {
            ...
            이처럼 맨 처음 (7 x 3 x 1 x 6 x 7 = 882) 부터 맨 끝 (6 x 3 x 4 x 5 x 0 = 0) 까지 5자리 숫자들의 곱을 구할 수 있습니다. 
            
            이렇게 구할 수 있는 5자리 숫자의 곱 중에서 가장 큰 값은 얼마입니까?
            */

            string arr = "73167176531330624919225119674426574742355349194934" +
                         "96983520312774506326239578318016984801869478851843" +
                         "85861560789112949495459501737958331952853208805511" +
                         "12540698747158523863050715693290963295227443043557" +
                         "66896648950445244523161731856403098711121722383113" +
            ...
            {
                num = int.Parse(arr[i].ToString()) * int.Parse(arr[i + 1].ToString()) *
                      int.Parse(arr[i + 2].ToString()) * int.Parse(arr[i + 3].ToString()) *
                      int.Parse(arr[i + 4].ToString());
                if (num > max)
                    max = num;
            }
        ...
        public static void Quiz101()
        {
            ...
            */
            ...
            Console.WriteLine("1 이상이고 5000 보다 작은 모든 셀프 넘버들의 합: {0}", answer);
        }
